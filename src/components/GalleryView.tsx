    ...
    <div className="space-y-10 pb-20 animate-fadeIn">
      ...
      <div className="bg-[#FFF5F8] rounded-[32px] p-8 sm:p-12 border border-[#F6B8C8]/20 text-center max-w-4xl mx-auto space-y-4">
        ...
        <p className="text-gray-500 text-sm max-w-2xl mx-auto">
          Explore real creations handcrafted in our Bandra West studio kitchen. Click on any post to view ingredients, custom client responses, or post a comment directly to our simulated social timeline!
        </p>
      </div>
              ...
              <div className="flex justify-between items-center pb-4 border-b border-gray-50 shrink-0">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-[#D63384] font-semibold uppercase tracking-wider">Bandra Studio Kitchen</p>
                  </div>
                </div>
                <button
                  onClick={() => setSelectedPostId(null)}
