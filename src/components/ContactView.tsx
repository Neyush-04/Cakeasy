      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-5 space-y-8">
          <div className="space-y-3">
            ...
            <h2 className="font-serif text-3xl font-bold text-[#1E1E1E]">Bandra West Atelier</h2>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-4 p-5 bg-white border border-[#FFF5F8] rounded-2xl">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">Bespoke Kitchen Studio, Phase II, Bandra West, Mumbai - 400050</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-5 bg-white border border-[#FFF5F8] rounded-2xl">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">+91 98765 43210 (Tasting Consultations)</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-5 bg-white border border-[#FFF5F8] rounded-2xl">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">hello@cakeasy.in / orders@cakeasy.in</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-neutral-100 rounded-3xl aspect-[16/10] relative overflow-hidden border border-neutral-200">
            ...
            <div className="absolute inset-0 bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:20px_20px] flex items-center justify-center">
              <div className="text-center space-y-2">
                ...
                <p className="text-[9px] text-gray-400">Near Carter Road, Bandra West</p>
              </div>
            </div>
          </div>
        </div>
