...
export const INSTAGRAM_POSTS: InstagramPost[] = [
  {
    ...
    caption: 'Handcrafted at our Greater Noida kitchen — swipe to see more angles. (Edit this caption from the Admin Dashboard)',
    likes: 47,
    commentsCount: 0,
    date: 'May 28, 2026',
    comments: []
...
export const MEET_THE_TEAM = [
  {
    ...
    bio: 'Cakeasy started as a passion for baking and has grown into a home-baked cake studio, crafting custom cakes for birthdays, weddings, and every celebration in between. (Edit this name/bio in data.ts with your real details.)',
